...
const defaultBots: TradingBot[] = [
  {
    id: '1', name: 'Arbitrage Hunter', strategy: 'arbitrage',
    description: '60% win rate bot. Detects price differences across markets. Lower risk, frequent small profits.',
    profit: 0, status: 'paused', risk: 'low', crypto: 'BTC', stakeAmount: 10,
    tradesCount: 0, winCount: 0, lossCount: 0, currentAction: 'SCANNING',
    winRate: 60, price: 100, image: botArbitrageImage,
  },
  {
    id: '2', name: 'Speed Scalper', strategy: 'scalping',
    description: '80% win rate bot. High-frequency trades on small price movements. Fast execution.',
    profit: 0, status: 'paused', risk: 'high', crypto: 'ETH', stakeAmount: 15,
    tradesCount: 0, winCount: 0, lossCount: 0, currentAction: 'SCANNING',
    winRate: 80, price: 150, image: botScalperImage,
  },
  {
    id: '3', name: 'Signal Master', strategy: 'signal',
    description: 'Free bot. Uses RSI, MA crossovers, and pattern recognition. 5% payout.',
    profit: 0, status: 'paused', risk: 'medium', crypto: 'SOL', stakeAmount: 20,
    tradesCount: 0, winCount: 0, lossCount: 0, currentAction: 'HOLD',
    winRate: 40, price: 0, image: botSignalImage,
  },
  {
    id: '4', name: 'Trend Follower', strategy: 'trend',
    description: 'Free bot. Follows market momentum and rides trends. 5% payout.',
    profit: 0, status: 'paused', risk: 'medium', crypto: 'BNB', stakeAmount: 10,
    tradesCount: 0, winCount: 0, lossCount: 0, currentAction: 'SCANNING',
    winRate: 45, price: 0, image: botTrendImage,
  },
  {
    id: '5', name: 'Grid Trader', strategy: 'grid',
    description: 'Free bot. Places orders at preset intervals. Profits from price oscillations. 5% payout.',
    profit: 0, status: 'paused', risk: 'low', crypto: 'XRP', stakeAmount: 10,
    tradesCount: 0, winCount: 0, lossCount: 0, currentAction: 'SCANNING',
    winRate: 50, price: 0, image: botGridImage,
  },
];
